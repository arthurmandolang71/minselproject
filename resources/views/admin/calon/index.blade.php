    ...
    <div class="content-body">
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active"><a href="/admindpd/">Admin</a></li>
                    <li class="breadcrumb-item"><a href="">Data Calon Pilkada</a></li>
                </ol>
            </div>
            <!-- row -->
            <div class="row">
