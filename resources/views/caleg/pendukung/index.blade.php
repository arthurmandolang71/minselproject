                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <!-- start content -->
                            <div class="container">
                                <form action="/pendukung/index" method="get">
                                    <div class="row">
                                        <div class="col-md-6">
                                    ...
                                    <tbody>
                                        @foreach ($pendukung as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($item->jml_referensi > 1)
                                                        <a href='/pendukung_daftar_referensi/{{ $item->id }}/'
                                                            type='button'
                                                            class='btn btn-rounded btn-danger'>{{ $item->jml_referensi }}
                                                            Data</span></a>
                                                    @else
                                                        {{ $item->relawan_ref->nama ?? null }}
                                                    @endif
                                                </td>
