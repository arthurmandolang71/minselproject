    ...
    <div class="content-body">
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active"><a href="/pendukung/dash?prov=71">Pendukung</a></li>
                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <!-- start content -->
                            <div class="container">
                                <form action="/pendukung/dash?prov=71" method="get">
                            ...
                            <div class="card">
                                <div class="card-header border-0 pb-0">
                                    <div>
                                        ...
                                        <span class="fs-12">Pendukung Berdasarkan Usia</span>
                                    </div>
                                </div>
                                <div class="card-body">
                            ...
                            <div class="card">
                                <div class="card-header border-0 pb-0">
                                    <div>
                                        ...
                                        <span class="fs-12">Pendukung berdasarkan Jenis Kelamin</span>
                                    </div>
                                </div>
                                <div class="card-body">
                            ...
                            <div class="card">
                                <div class="card-header border-0 pb-0">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-black fs-18">Pendukung</span>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
