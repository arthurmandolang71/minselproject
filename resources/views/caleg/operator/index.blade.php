    ...
    <div class="content-body">
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active"><a href="/operator/">Operator</a></li>
                    <li class="breadcrumb-item"><a href="">Data Oparator</a></li>
                </ol>
            </div>
            <!-- row -->
            <div class="row">
                <div class="col-xl-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="col-md-4">
                                <a href="/operator/create" class="btn btn-block btn-primary"><span
                                        class="btn-icon-start text-primary"><i class="fa fa-plus"></i>
                                    </span>Tambah Operator</a>
                            </div>
                            <br>
