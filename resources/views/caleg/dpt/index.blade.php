                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <!-- start content -->
                            <div class="container">
                                <form action="/collectdata" method="get">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if (isset($item->pendukung->pendukung_caleg_prov))
                                                        <a href='/pendukung_referensi/create/{{ $item->id }}/{{ $status }}'
                                                            type='button' class='btn btn-rounded btn-warning'><span
                                                                class='btn-icon-start text-warning'><i
                                                                    class='fa fa-plus color-warning'></i></span></a>
                                                    @else
                                                        <a href='/pendukung/create/{{ $item->id }}/{{ $status }}'
